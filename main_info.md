...
мемристор
есть модель от Joglekar. у нее два контакта A, B. Если за входной взять B, то будет как мы привыкли в лаборатории (затыкается положительным напряжением). Положительное еще позволяет плавно опустить ветку. 
